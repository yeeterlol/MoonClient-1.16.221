		...
		public event KeyEventHandler KeyDown
		{
			...
			add
			{
				...
				do
				{
					...
					val = Interlocked.CompareExchange(ref global::System.Runtime.CompilerServices.Unsafe.As<KeyEventHandler, KeyEventHandler>(ref this.KeyDown), value2, val2);
				}
				while (val != val2);
			}
			[CompilerGenerated]
		...
		public event KeyPressEventHandler KeyPress
		{
			...
			add
			{
				...
				do
				{
					...
					val = Interlocked.CompareExchange(ref global::System.Runtime.CompilerServices.Unsafe.As<KeyPressEventHandler, KeyPressEventHandler>(ref this.KeyPress), value2, val2);
				}
				while (val != val2);
			}
			[CompilerGenerated]
		...
		public event KeyEventHandler KeyUp
		{
			...
			add
			{
				...
				do
				{
					val2 = val;
					KeyEventHandler value2 = (KeyEventHandler)Delegate.Combine((Delegate?)(object)val2, (Delegate?)(object)value);
					val = Interlocked.CompareExchange(ref global::System.Runtime.CompilerServices.Unsafe.As<KeyEventHandler, KeyEventHandler>(ref this.KeyUp), value2, val2);
				}
				while (val != val2);
			}
			[CompilerGenerated]
